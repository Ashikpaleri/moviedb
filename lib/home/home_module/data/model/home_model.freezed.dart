...
mixin _$HomeModel {
  ...
  List<HomeResultsModel>? get results => throw _privateConstructorUsedError;
...
class _$_HomeModel with DiagnosticableTreeMixin implements _HomeModel {
  ...
  @override
  final int? page;
  final List<HomeResultsModel>? _results;
  @override
  List<HomeResultsModel>? get results {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'HomeModel(page: $page, results: $results, totalPages: $totalPages, totalResults: $totalResults)';
  }
...
abstract class _HomeModel implements HomeModel {
  const factory _HomeModel(
      ...
      final List<HomeResultsModel>? results,
      final int? totalPages,
      final int? totalResults}) = _$_HomeModel;
